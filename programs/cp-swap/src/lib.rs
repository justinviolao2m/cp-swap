...
solana_security_txt::security_txt! {
    ...
    contacts: "link:https://",
    policy: "https://",
    source_code: "https://github.com//cp-swap",
    preferred_languages: "en",
    auditors: "pdf link here"
}

#[cfg(feature = "devnet")]
declare_id!("CPMDWBwJDtYax9qW7AyRuVC19Cc4L4Vcy4n2BHAbHkCW");
#[cfg(not(feature = "devnet"))]
declare_id!("GxA65QbqVGnLJDSodpn5HU6E1GQjRhkv3GoUUhBgYm3j");
...
pub mod admin {
    ...
    #[cfg(not(feature = "devnet"))]
    declare_id!("8ZDkNrxFJtxvD2yNLVpEpzuMQxKbGRbgutCuoH5kyYat");
}
