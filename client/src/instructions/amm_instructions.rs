...
use cp_swap::accounts as cp_accounts;
use cp_swap::instruction as cp_instructions;
use cp_swap::{
...
pub fn initialize_pool_instr(
    ...
    let instructions = program
        .request()
        .accounts(cp_accounts::Initialize {
        ...
        .args(cp_instructions::Initialize {
            init_amount_0,
            init_amount_1,
            open_time,
        })
...
pub fn swap_base_input_instr(
    ...
    let instructions = program
        ...
        .args(cp_instructions::SwapBaseInput {
            amount_in,
            minimum_amount_out,
        })
        .instructions()?;
...
pub fn swap_base_output_instr(
    ...
    let instructions = program
        ...
        .args(cp_instructions::SwapBaseOutput {
            max_amount_in,
            amount_out,
        })
        .instructions()?;
